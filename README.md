[![Run App Joshua Ostblom](https://github.com/joshostblom/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/joshostblom/GithubActions/actions/workflows/run-app.yaml)
